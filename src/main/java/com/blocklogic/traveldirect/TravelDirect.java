package com.blocklogic.traveldirect;
...
@Mod(TravelDirect.MODID)
public class TravelDirect
{
    // Define mod id in a common place for everything to reference
    public static final String MODID = "traveldirect";
    ...
    public TravelDirect(IEventBus modEventBus, ModContainer modContainer)
    {
